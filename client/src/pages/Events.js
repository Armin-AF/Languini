  ...
  return (
    isAuthenticated && (
      <div>
        ...
        <h1 className="text-1xl text-center font-bold text-gray-800 mt-10 shadow pb-10">Search for a language to begin. Can't find a suitable event? Simply create your own!</h1>

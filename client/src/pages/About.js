    ...
    return (
        <div>
            <section className="relative z-10 overflow-hidden bg-white py-20 lg:py-[120px]">
                    ...
                    <div className="-mx-4 flex flex-wrap lg:justify-between">
                        <div className="w-full px-4 lg:w-1/2 xl:w-6/12">
                            <div className="mb-12 max-w-[570px] lg:mb-0">
                                ...
                                We are a Stockholm based scale up, started at Salt, school of applied technology. We are currently a small core team of four people.  
                                </p>
                                <div className="mb-8 flex w-full max-w-[370px]">
                                    ...
                                    <div className="w-full">
                                        ...
                                        At Languini we are all about connecting people. Our mission is encouraging curios people to connect, enabling learning new languages and finding new friends! 
              ...
              <textarea
                  rows="6"
                  placeholder="Feel free to contact us!  "

		...
		<div class="w-full md:w-1/3 bg-white grid place-items-center">
			...
			<div class="w-full md:w-2/3 bg-white flex flex-col space-y-2 p-3">
				<div class="flex justify-between item-center">
					<p class="text-gray-600 font-bold hidden md:block">{props.location}</p>
					<div class="flex items-center">
						<p class="text-gray-600 font-bold text-sm ml-1">
							{props.date}
						</p>
					</div>
					<button class="bg-cyan-400 px-3 py-1 rounded-full text-xs font-medium text-gray-800 hidden md:block w-20">Join</button>
				</div>
				<h3 class="font-black text-gray-800 md:text-3xl text-xl">{props.language}</h3>

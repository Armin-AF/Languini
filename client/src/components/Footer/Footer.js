              ...
              {/* Facebook */}
                ...
                <svg fill="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" className="w-6 h-6" viewBox="0 0 24 24">
                  <path d="M23 3a10.9 10.9 0 01-3.14 1.53 4.48 4.48 0 00-7.86 3v1A10.66 10.66 0 013 4s-4 9 5 13a11.64 11.64 0 01-7 2c9 5 20 0 20-11.5a4.5 4.5 0 00-.08-.83A7.72 7.72 0 0023 3z"></path>
                            ...
                            {/* Instagram */}
                            <a href="https://www.instagram.com/school_of_applied_technology/" className="ml-3 text-gray-200">
                ...
                <svg fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" className="w-6 h-6" viewBox="0 0 24 24">
                  ...
                  <path d="M16 11.37A4 4 0 1112.63 8 4 4 0 0116 11.37zm1.5-4.87h.01"></path>
                            ...
                            {/* Linkedin */}
                            <a href={"https://www.linkedin.com/company/applied-technology-stockholm/mycompany/"} className="ml-3 text-gray-200">
                ...
                <svg fill="currentColor" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="0" className="w-6 h-6" viewBox="0 0 24 24">
                  ...
                  <circle cx="4" cy="4" r="2" stroke="none"></circle>
                        ...
                        {/* :::Copyright */}
                        <span className="py-4 text-xs">&copy;2022, SALT All Rights Reserved.</span>
                    </div>
                ...
                <div className="grid grid-cols-2 gap-5 text-gray-400">
                    ...
                    <div className="col-span-2 md:col-span-1 pb-0 md:py-3 px-4 flex flex-col items-center sm:items-start">
                        ...
                        <p className="md:w-48 text-center sm:text-left text-lg md:text-xl font-medium">Lustgårdsgatan 19 112 51</p>
                    </div>
                    {/* ::Email */}
                    <div className="col-span-2 md:col-span-1 pb-0 md:py-3 px-4 flex flex-col items-center sm:items-start">
                        <h3 className="py-1.5 md:py-4 text-xl text-gray-500 font-bold tracking-wide">Our Company</h3>
                        <p className="inline-flex justify-center sm:justify-start text-sm text-gray-400 font-medium">
                            ...
                            <a href="#email">info@Languini.com</a>
                        </p>
                    </div>
                    {/* ::Phone */}
                    <div className="col-span-2 md:col-span-1 pb-0 md:py-3 px-4 flex flex-col items-center sm:items-start">
